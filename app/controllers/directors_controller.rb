class DirectorsController < ApplicationController
  ...
  def index
    ...
    @directors = @q.result(:distinct => true).includes(:movies, :reviews, :bookmarks).page(params[:page]).per(10)
  end
  ...
  private
    ...
    def director_params
      params.require(:director).permit(:date_of_birth, :name, :bio, :image, :filmography)
    end
end
